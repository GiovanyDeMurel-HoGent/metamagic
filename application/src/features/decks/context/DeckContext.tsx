...
type DeckContextType = {
    ...
    setInitialCards: (cards:Array<Card> | null)=>void
...
export const DeckProvider = ({children}:{ children: React.ReactNode }) => {
    ...
    const [initialCards, setInitialCards] = useState<Array<Card>|null>([]);
    ...
    return(
        <DeckContext.Provider value={{
            loading, setLoading,
            deck,setDeck,cards,setCards,initialCards,setInitialCards,selectedCard,setSelectedCard,selectedSearchCard,setSelectedSearchCard,
            displayCardDetails,setDisplayCardDetails
        }}>
        {children}
